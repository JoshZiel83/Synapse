...
export const DEVICE_CAPABILITY_ACCESS_SUBJECT_KIND = {
  WORKSPACE: "workspace",
  ACTOR: "actor",
  REMOTE_AGENT: "remote_agent",
  CONVERSATION: "conversation",
} as const
export const DEVICE_CAPABILITY_ACCESS_SUBJECT_KINDS = [
...
export const DEVICE_CAPABILITY_ACCESS_SCOPE_KIND = {
  CONVERSATION: "conversation",
} as const
export const DEVICE_CAPABILITY_ACCESS_SCOPE_KINDS = [
