              ...
              <SidebarMenuItem key={item.href}>
                <SidebarMenuButton asChild isActive={active} tooltip={item.label}>
                  <Link href={item.href}>
                    ...
                    {badge > 0 ? (
                      <span className="ml-auto flex min-w-5 items-center justify-center rounded-full bg-indigo-600 px-1.5 py-0.5 text-[10px] font-bold text-white">
                        {badge > 99 ? "99+" : badge}
                      </span>
                    ) : null}
                  </Link>
      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <Avatar className="size-8 rounded-lg bg-gray-100 dark:bg-gray-800">
                <AvatarFallback className="rounded-lg bg-indigo-600 text-xs text-white">{initials}</AvatarFallback>
              </Avatar>
