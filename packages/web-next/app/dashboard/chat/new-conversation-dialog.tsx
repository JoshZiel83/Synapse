  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="bg-white dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-white/10 p-0 w-[calc(100vw-2rem)] max-w-[calc(100vw-2rem)] sm:max-w-[920px] overflow-hidden"
      >
        <div className="grid h-[min(560px,calc(100vh-5rem))] grid-cols-2">

          {/* Left: actor list */}
          <div className="flex min-w-0 min-h-0 flex-col border-r border-gray-200 dark:border-white/10">
            {/* Search */}
