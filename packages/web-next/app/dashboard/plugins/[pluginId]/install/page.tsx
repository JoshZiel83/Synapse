...
export default function PluginInstallPage() {
  ...
  return (
    <div className="flex flex-col gap-6 px-4 pb-6 pt-6 lg:px-6">
      ...
      <PluginHeroCard plugin={plugin} eyebrow={installation ? 'Setup' : 'New configuration'} />

      <AppCard variant="panel">
        <AppCardHeader className="px-6 py-6">
          <AppCardTitle>{installation ? 'Update setup' : 'Create configuration'}</AppCardTitle>
          <AppCardDescription>
            {installation
        ...
        <AppCardContent className="min-h-0 px-6 pb-6 pt-0">
          <InstallDialog
            plugin={plugin}
            ...
            defaultAttachmentType={isBuiltinInitialInstall ? 'workspace_member' : undefined}
