...
export function LandingTeamGovernanceSection() {
  return (
    ...
    >
      ...
      <div className="landing-priority-frame relative mx-auto flex flex-col max-w-7xl px-6 lg:px-8">
        ...
        <div className="landing-priority-showcase relative mt-8 lg:mt-12">
          <div className="absolute -left-10 top-10 size-36 rounded-full bg-sky-200/35 blur-3xl" />
          <div className="absolute -right-2 bottom-10 size-40 rounded-full bg-emerald-200/30 blur-3xl" />

          <LandingStagger className="grid gap-4 xl:grid-cols-[1.12fr_0.94fr_0.94fr]" delay={0.12} stagger={0.1}>
            <LandingStaggerItem>
              ...
              <CardContent className="p-5 lg:p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-slate-950">团队和个人并存</div>
                    <div className="mt-1 text-[11px] text-slate-500">个人可配自己的工具，也可共享；团队也能统一配置团队工具</div>
                  </div>
                </div>

                <LandingStagger className="mt-5 space-y-3" delay={0.08} stagger={0.08}>
                  <LandingStaggerItem className="rounded-[28px] border border-slate-200 bg-[linear-gradient(180deg,rgba(248,250,252,0.96),rgba(241,245,249,0.88))] p-4">
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-semibold text-slate-950">个人环境</div>
                          <div className="mt-1 text-[11px] text-slate-500">给自己配工具，也可选择共享</div>
                        </div>
                      </div>
                    </div>
                  ...
                  <LandingStaggerItem className="rounded-[28px] border border-sky-200 bg-[linear-gradient(180deg,rgba(240,249,255,0.96),rgba(236,253,245,0.82))] p-4">
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-semibold text-slate-950">团队环境</div>
                          <div className="mt-1 text-[11px] text-slate-500">团队也能直接统一配置，多人复用</div>
                        </div>
                      </div>
                    </div>
            ...
            <LandingStaggerItem>
              ...
              <CardContent className="p-5 lg:p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-slate-950">权限管理</div>
                    <div className="mt-1 text-[11px] text-slate-500">谁能装、谁能用、谁能改，一眼看清</div>
                  </div>
                </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <div className="mt-1 text-[12px] leading-5 text-slate-500">{item.summary}</div>
                        </div>
                        <div className={`rounded-full px-2.5 py-1 text-[11px] leading-none ${item.tone}`}>
                          生效中
                        </div>
                      </div>
                    </LandingStaggerItem>
            ...
            <LandingStaggerItem>
              ...
              <CardContent className="p-5 lg:p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-slate-950">日志审计</div>
                    <div className="mt-1 text-[11px] text-slate-500">关键动作和环境变化都有记录</div>
                  </div>
                </div>

                <LandingStagger className="mt-5 space-y-3" delay={0.08} stagger={0.08}>
                  {auditItems.map((item) => (
                    <LandingStaggerItem key={`${item.time}-${item.action}`} className="flex gap-3">
                      <div className="pt-1">
                      ...
                      <div className="rounded-[22px] border border-slate-200 bg-slate-50/88 px-3.5 py-3">
                        ...
                        <div className="mt-1 text-[13px] font-semibold text-slate-950">{item.action}</div>
