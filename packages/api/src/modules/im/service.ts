...
/**
 * transport_addresses + conversation_participant_addresses — extracted to
 * service/addresses.ts. service.ts re-exports to keep call sites stable.
 * `ensureTransportAddress`, `setTransportAddressLinkedUser`, and
 * `assertWorkspaceMember` are imported above (they're called from this file
 * too) and re-exported here for back-compat.
 */
export {
  ensureTransportAddress,
  setTransportAddressLinkedUser,
