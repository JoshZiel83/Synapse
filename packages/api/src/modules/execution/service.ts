...
export async function logProviderStep(params: {
  ...
  const result = await query(
    `INSERT INTO provider_steps
       (id, turn_id, step_index, provider_type, request_type, model_group_id, model_item_id,
        model_config_id, model_name, capabilities_snapshot, request_payload_blob_id, response_payload_blob_id,
     ...
     DO UPDATE SET
       ...
       model_item_id = EXCLUDED.model_item_id,
