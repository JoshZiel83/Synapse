...
import {
  ...
  type ChatClientInstanceRegistrationRecord,
 ...
 * outbox atomic; they call this directly with their `trx`. Root-executor callers go
 ...
 * outbox stay atomic. If the caller passes the root executor (autocommit), open a
