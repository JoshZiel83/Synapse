...
export const ACCESS_ACTIONS = {
  ...
  'workspace.manage_capabilities': { resourceType: 'workspace', permission: 'manage_capabilities' },
  ...
  'plugin.view': { resourceType: 'plugin_instance', permission: 'view' },
  'plugin.use': { resourceType: 'plugin_instance', permission: 'use' },
  'plugin.edit': { resourceType: 'plugin_instance', permission: 'edit' },
  'plugin.grant': { resourceType: 'plugin_instance', permission: 'grant' },
  'plugin.delete': { resourceType: 'plugin_instance', permission: 'delete' },

  'skill.view': { resourceType: 'skill_instance', permission: 'view' },
  'skill.use': { resourceType: 'skill_instance', permission: 'use' },
  'skill.edit': { resourceType: 'skill_instance', permission: 'edit' },
  'skill.grant': { resourceType: 'skill_instance', permission: 'grant' },
  'skill.delete': { resourceType: 'skill_instance', permission: 'delete' },
