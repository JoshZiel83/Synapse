...
export const feishuSeed: BuiltinOrgSeed = {
  ...
  displayName: "Feishu",
  description:
    "Feishu plugin with QR setup, feature-scoped permissions, and Synapse-native tools.",
  plugins: [
    {
      slug: "app",
      displayName: "Feishu",
        ...
        steps: [
          {
            ...
            fields: ["features"],
            helpUrl:
              "https://open.feishu.cn/document/home/introduction-to-lark-open-platform",
            helpTextI18n: i18n(
      ...
      authorization: {
        ...
        reason:
          "Feishu integration needs outbound network access to call Feishu OpenAPI endpoints on behalf of the connected account.",
      },
    },
  ],
}
