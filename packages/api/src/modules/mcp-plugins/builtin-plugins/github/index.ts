...
export const githubSeed: BuiltinOrgSeed = {
  slug: "github",
  displayName: "GitHub",
  description: "GitHub official MCP integration with optional GitHub API-backed automation event sources.",
  plugins: [
    {
      slug: "official-mcp",
      displayName: "GitHub Official MCP",
      description: "Connect to GitHub's official MCP server and reuse the same credentials for GitHub repository event sources.",
      longDescription:
      ...
      validationRules: [
        { field: "apiKey", rule: "required", message: "GitHub token is required." },
        { field: "apiKey", rule: "min_length", value: 20, message: "GitHub token looks too short." },
      ],
      setupSteps: [
        {
          id: "credentials",
          title: "Configure GitHub",
          description: "Paste a GitHub token that can access the repositories you need.",
          scope: "plugin",
          fields: ["apiKey", "apiBaseUrl"],
          helpUrl: "https://docs.github.com/en/copilot/how-tos/context/model-context-protocol/using-the-github-mcp-server",
      ...
      authorization: {
        ...
        reason: "GitHub official MCP and GitHub webhook management require outbound network access.",
      },
    },
  ],
};
