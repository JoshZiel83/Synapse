...
export const amapSeed: BuiltinOrgSeed = {
  ...
  displayName: "AMap",
  description:
    "AMap location toolkit for geocoding, POI search, district lookup, weather, IP location, coordinate conversion, and route planning.",
  plugins: [
    {
      slug: "openapi",
      ...
      configSchema: {
        ...
        properties: {
          ...
          sig: {
            ...
            sensitive: true,
            description:
              "Optional AMap digital signature if your account requires signed requests.",
          },
          timeoutMs: {
            type: "integer",
      ...
      validationRules: [
        ...
        },
        {
          ...
          rule: "min_length",
          value: 8,
          message: "AMap signature looks too short",
        },
      ],
      setupSteps: [
        {
          ...
          description:
            "Add your AMap Web Service API key. A digital signature is optional and only needed for accounts that require signed requests.",
          scope: "plugin",
          fields: ["apiKey", "sig"],
          helpUrl: "https://lbs.amap.com/api/webservice/summary/",
          helpText:
            "Use a Web Service API key from the AMap developer console.",
        },
      ],
      installFlow: {
        steps: [
