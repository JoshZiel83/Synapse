...
async function loadInstallationRows(
  ...
  const result = await db.executeQuery(
    sql<InstallationRow>`SELECT
        ...
        primary_access.subject_user_id AS primary_user_id,
    ...
    const insertedAccess = await executeTakeFirst<{ id: string }>(
      ...
      db
        ...
        .values({
          ...
          subject_user_id: primaryAccessTarget.subjectUserId,
    ...
    if (data.attachmentTarget) {
      ...
      await run(
        ...
        [
          ...
          nextPrimaryAccessTarget.subjectUserId,
    ...
    const inserted = await executeTakeFirst(
      ...
      db
        ...
        .values({
          ...
          subject_user_id: accessTarget.subjectUserId,
