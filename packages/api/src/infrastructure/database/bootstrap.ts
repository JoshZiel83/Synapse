...
const CURRENT_SCHEMA_VERSION = "2026-05-23-im-api"
const CURRENT_SCHEMA_DESCRIPTION =
  "rename participant_kind -> participant_type (column + ENUM); rename relationship_target_type value 'member' -> 'workspace_member'; add chat_push_tokens"
