...
BEGIN
  ...
  UPDATE conversations SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE audit_logs SET user_id = NULL WHERE workspace_id = p_workspace_id AND user_id IS NOT NULL;
  UPDATE file_assets SET uploader_user_id = NULL WHERE workspace_id = p_workspace_id AND uploader_user_id IS NOT NULL;
  UPDATE publishers SET logo_file_id = NULL WHERE workspace_id = p_workspace_id AND logo_file_id IS NOT NULL;
  UPDATE publishers SET owner_user_id = NULL WHERE workspace_id = p_workspace_id AND owner_user_id IS NOT NULL;
  UPDATE catalog_items SET icon_file_id = NULL WHERE workspace_id = p_workspace_id AND icon_file_id IS NOT NULL;
  UPDATE catalog_items SET mirror_source_id = NULL WHERE workspace_id = p_workspace_id AND mirror_source_id IS NOT NULL;
  UPDATE actors SET avatar_file_id = NULL WHERE workspace_id = p_workspace_id AND avatar_file_id IS NOT NULL;
  UPDATE actors SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE remote_agents SET avatar_file_id = NULL WHERE workspace_id = p_workspace_id AND avatar_file_id IS NOT NULL;
  UPDATE remote_agents SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE remote_agent_machines SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE workspace_relationship_profiles SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE workspace_friend_entries SET source_request_id = NULL WHERE workspace_id = p_workspace_id AND source_request_id IS NOT NULL;
  UPDATE entity_access_requests SET resolved_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND resolved_by_workspace_member_id IS NOT NULL;
  UPDATE model_profiles SET installed_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND installed_by_workspace_member_id IS NOT NULL;
  UPDATE transport_accounts SET inbound_actor_id = NULL WHERE workspace_id = p_workspace_id AND inbound_actor_id IS NOT NULL;
  UPDATE conversation_transport_bindings SET inbound_actor_id = NULL WHERE workspace_id = p_workspace_id AND inbound_actor_id IS NOT NULL;
  UPDATE transport_addresses SET workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND workspace_member_id IS NOT NULL;
  UPDATE workspace_member_sync_events SET item_id = NULL WHERE workspace_id = p_workspace_id AND item_id IS NOT NULL;
  UPDATE tool_call_tasks SET turn_id = NULL WHERE workspace_id = p_workspace_id AND turn_id IS NOT NULL;
  UPDATE tool_call_tasks SET source_tool_call_id = NULL WHERE workspace_id = p_workspace_id AND source_tool_call_id IS NOT NULL;
  UPDATE tool_call_tasks SET completion_item_id = NULL WHERE workspace_id = p_workspace_id AND completion_item_id IS NOT NULL;
  UPDATE automation_rules SET created_by_session_id = NULL WHERE workspace_id = p_workspace_id AND created_by_session_id IS NOT NULL;
  UPDATE automation_event_sources SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE automation_event_sources SET created_by_actor_id = NULL WHERE workspace_id = p_workspace_id AND created_by_actor_id IS NOT NULL;
  UPDATE automation_event_sources SET created_by_session_id = NULL WHERE workspace_id = p_workspace_id AND created_by_session_id IS NOT NULL;
  UPDATE automation_webhook_endpoints SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE automation_occurrences SET event_source_id = NULL WHERE workspace_id = p_workspace_id AND event_source_id IS NOT NULL;
  UPDATE memory_recall_runs SET actor_id = NULL WHERE workspace_id = p_workspace_id AND actor_id IS NOT NULL;
  UPDATE memory_recall_runs SET conversation_id = NULL WHERE workspace_id = p_workspace_id AND conversation_id IS NOT NULL;
  UPDATE memory_recall_runs SET workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND workspace_member_id IS NOT NULL;
  UPDATE runtime_events SET workspace_id = NULL WHERE workspace_id = p_workspace_id AND workspace_id IS NOT NULL;
  UPDATE runtime_events SET conversation_id = NULL WHERE workspace_id = p_workspace_id AND conversation_id IS NOT NULL;
  UPDATE runtime_events SET session_id = NULL WHERE workspace_id = p_workspace_id AND session_id IS NOT NULL;
  UPDATE runtime_events SET turn_id = NULL WHERE workspace_id = p_workspace_id AND turn_id IS NOT NULL;
  UPDATE runtime_events SET provider_step_id = NULL WHERE workspace_id = p_workspace_id AND provider_step_id IS NOT NULL;
  UPDATE runtime_events SET tool_call_id = NULL WHERE workspace_id = p_workspace_id AND tool_call_id IS NOT NULL;
  UPDATE runtime_events SET tool_attempt_id = NULL WHERE workspace_id = p_workspace_id AND tool_attempt_id IS NOT NULL;
  UPDATE runtime_events SET actor_id = NULL WHERE workspace_id = p_workspace_id AND actor_id IS NOT NULL;
  UPDATE runtime_events SET user_id = NULL WHERE workspace_id = p_workspace_id AND user_id IS NOT NULL;
  UPDATE installed_skills SET icon_file_id = NULL WHERE workspace_id = p_workspace_id AND icon_file_id IS NOT NULL;
  UPDATE installed_skills SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE plugin_installations SET installed_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND installed_by_workspace_member_id IS NOT NULL;
  UPDATE plugin_auth_sessions SET catalog_version_id = NULL WHERE workspace_id = p_workspace_id AND catalog_version_id IS NOT NULL;
  UPDATE plugin_connections SET owner_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND owner_workspace_member_id IS NOT NULL;
  UPDATE resource_access_bindings SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE interaction_requests SET conversation_item_id = NULL WHERE workspace_id = p_workspace_id AND conversation_item_id IS NOT NULL;
  UPDATE interaction_transport_projections SET transport_message_link_id = NULL WHERE workspace_id = p_workspace_id AND transport_message_link_id IS NOT NULL;
  UPDATE runtime_authorization_grants SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE runtime_authorization_grants SET source_interaction_id = NULL WHERE workspace_id = p_workspace_id AND source_interaction_id IS NOT NULL;
  UPDATE runtime_authorization_grants SET source_task_id = NULL WHERE workspace_id = p_workspace_id AND source_task_id IS NOT NULL;
  UPDATE devices SET owner_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND owner_workspace_member_id IS NOT NULL;
  UPDATE device_pairing_sessions SET requested_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND requested_by_workspace_member_id IS NOT NULL;
  UPDATE device_pairing_sessions SET device_id = NULL WHERE workspace_id = p_workspace_id AND device_id IS NOT NULL;
  UPDATE device_operations SET conversation_id = NULL WHERE workspace_id = p_workspace_id AND conversation_id IS NOT NULL;
  UPDATE device_operations SET task_id = NULL WHERE workspace_id = p_workspace_id AND task_id IS NOT NULL;
  UPDATE device_operations SET initiated_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND initiated_by_workspace_member_id IS NOT NULL;
  UPDATE device_operations SET initiated_by_session_id = NULL WHERE workspace_id = p_workspace_id AND initiated_by_session_id IS NOT NULL;
  UPDATE device_operations SET runtime_session_id = NULL WHERE workspace_id = p_workspace_id AND runtime_session_id IS NOT NULL;
  UPDATE memory_access_grants SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE memory_access_grants SET source_interaction_id = NULL WHERE workspace_id = p_workspace_id AND source_interaction_id IS NOT NULL;
  UPDATE file_snapshots SET created_by_session_id = NULL WHERE workspace_id = p_workspace_id AND created_by_session_id IS NOT NULL;
  UPDATE file_access_grants SET created_by_workspace_member_id = NULL WHERE workspace_id = p_workspace_id AND created_by_workspace_member_id IS NOT NULL;
  UPDATE file_access_grants SET source_interaction_id = NULL WHERE workspace_id = p_workspace_id AND source_interaction_id IS NOT NULL;
  UPDATE file_mounts SET device_id = NULL WHERE workspace_id = p_workspace_id AND device_id IS NOT NULL;
  UPDATE file_mounts SET pairing_session_id = NULL WHERE workspace_id = p_workspace_id AND pairing_session_id IS NOT NULL;
  UPDATE file_mounts SET base_snapshot_id = NULL WHERE workspace_id = p_workspace_id AND base_snapshot_id IS NOT NULL;
  UPDATE file_mounts SET result_snapshot_id = NULL WHERE workspace_id = p_workspace_id AND result_snapshot_id IS NOT NULL;
  UPDATE catalog_items SET latest_version_id = NULL WHERE workspace_id = p_workspace_id AND latest_version_id IS NOT NULL;
  UPDATE model_profiles SET current_revision_id = NULL WHERE workspace_id = p_workspace_id AND current_revision_id IS NOT NULL;
  UPDATE sessions SET active_plan_approval_interaction_id = NULL WHERE workspace_id = p_workspace_id AND active_plan_approval_interaction_id IS NOT NULL;
  UPDATE file_spaces SET current_snapshot_id = NULL WHERE workspace_id = p_workspace_id AND current_snapshot_id IS NOT NULL;

  -- 2. delete workspace-scoped rows leaf→root
  DELETE FROM audit_logs WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM chat_conversation_create_requests WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM conversation_transport_bindings WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM device_pairing_sessions WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM entity_access_requests WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM file_access_grants WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM file_mounts WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM file_snapshots WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM interaction_transport_projections WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM memory_access_grants WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM memory_item_chunks WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM plugin_auth_sessions WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM plugin_connections WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM realtime_event_outbox WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM resource_access_bindings WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM runtime_authorization_grants WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM runtime_events WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM transport_message_links WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM workspace_friend_entries WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM workspace_invites WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM workspace_member_sync_events WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM workspace_relationship_profiles WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM automation_event_sources WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM automation_executions WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM chat_client_instances WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM device_operations WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM file_spaces WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM installed_skills WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM interaction_requests WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM memory_items WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM memory_recall_runs WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM model_profiles WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM automation_integration_bindings WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM automation_occurrences WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM automation_rules WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM device_capabilities WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM file_assets WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM memory_spaces WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM tool_call_tasks WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM automation_webhook_endpoints WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM plugin_installations WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM access_subjects WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM sessions WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM actors WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM catalog_items WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM conversations WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM remote_agents WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM transport_addresses WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM devices WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM publishers WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM remote_agent_machines WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM transport_accounts WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
  DELETE FROM workspace_members WHERE workspace_id = p_workspace_id; GET DIAGNOSTICS v_n = ROW_COUNT; v_total := v_total + v_n;
...
-- deleted_at; safe to run repeatedly (idempotent).
...
GRANT SELECT, UPDATE, DELETE ON access_subjects, account, actors, audit_logs, automation_event_sources, automation_executions, automation_integration_bindings, automation_occurrences, automation_rules, automation_webhook_endpoints, catalog_items, chat_client_instances, chat_conversation_create_requests, conversation_transport_bindings, conversations, device_capabilities, device_operations, device_pairing_sessions, devices, entity_access_requests, file_access_grants, file_assets, file_mounts, file_snapshots, file_spaces, installed_skills, interaction_requests, interaction_transport_projections, memory_access_grants, memory_item_chunks, memory_items, memory_recall_runs, memory_spaces, model_groups, model_profiles, plugin_auth_sessions, plugin_connections, plugin_installations, publishers, realtime_event_outbox, remote_agent_machines, remote_agents, resource_access_bindings, runtime_authorization_grants, runtime_events, sessions, tool_call_tasks, transport_accounts, transport_addresses, transport_message_links, users, workspace_friend_entries, workspace_invites, workspace_member_sync_events, workspace_members, workspace_relationship_profiles, workspaces TO synapse_purge_fn_owner;
