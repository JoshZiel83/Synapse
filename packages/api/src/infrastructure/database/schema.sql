...
CREATE TRIGGER sd_fk_live_platform_access_bindings_assigned_by_user_id BEFORE INSERT OR UPDATE OF assigned_by_user_id, status ON platform_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('users', 'assigned_by_user_id', 'id', 'false', 'active');
...
CREATE TRIGGER sd_fk_live_workspace_access_bindings_assigned_by_workspace_member_id BEFORE INSERT OR UPDATE OF assigned_by_workspace_member_id, status ON workspace_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'assigned_by_workspace_member_id', 'id', 'false', 'active');
...
CREATE TRIGGER sd_fk_live_workspace_invites_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id ON workspace_invites FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_conversations_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at ON conversations FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', '');
...
DROP TRIGGER IF EXISTS sd_fk_live_actors_created_by_workspace_member_id ON actors;
CREATE TRIGGER sd_fk_live_actors_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at ON actors FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', '');
...
DROP TRIGGER IF EXISTS sd_fk_live_remote_agents_created_by_workspace_member_id ON remote_agents;
CREATE TRIGGER sd_fk_live_remote_agents_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at ON remote_agents FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', '');
...
CREATE TRIGGER sd_fk_live_remote_agent_machines_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at ON remote_agent_machines FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', '');
...
CREATE TRIGGER sd_fk_live_workspace_relationship_profiles_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id ON workspace_relationship_profiles FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', '');
DROP TRIGGER IF EXISTS sd_fk_live_workspace_friend_requests_requester_workspace_member_id ON workspace_friend_requests;
CREATE TRIGGER sd_fk_live_workspace_friend_requests_requester_workspace_member_id BEFORE INSERT OR UPDATE OF requester_workspace_member_id ON workspace_friend_requests FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'requester_workspace_member_id', 'id', 'false', '');
DROP TRIGGER IF EXISTS sd_fk_live_workspace_friend_requests_resolved_by_workspace_member_id ON workspace_friend_requests;
CREATE TRIGGER sd_fk_live_workspace_friend_requests_resolved_by_workspace_member_id BEFORE INSERT OR UPDATE OF resolved_by_workspace_member_id ON workspace_friend_requests FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'resolved_by_workspace_member_id', 'id', 'false', '');
...
DROP TRIGGER IF EXISTS sd_fk_live_entity_access_requests_requester_workspace_member_id ON entity_access_requests;
CREATE TRIGGER sd_fk_live_entity_access_requests_requester_workspace_member_id BEFORE INSERT OR UPDATE OF requester_workspace_member_id ON entity_access_requests FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'requester_workspace_member_id', 'id', 'false', '');
DROP TRIGGER IF EXISTS sd_fk_live_entity_access_requests_resolved_by_workspace_member_id ON entity_access_requests;
CREATE TRIGGER sd_fk_live_entity_access_requests_resolved_by_workspace_member_id BEFORE INSERT OR UPDATE OF resolved_by_workspace_member_id ON entity_access_requests FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'resolved_by_workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_actor_versions_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id ON actor_versions FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', '');
DROP TRIGGER IF EXISTS sd_fk_live_actor_versions_source_workspace_member_id ON actor_versions;
CREATE TRIGGER sd_fk_live_actor_versions_source_workspace_member_id BEFORE INSERT OR UPDATE OF source_workspace_member_id ON actor_versions FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'source_workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_model_groups_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at ON model_groups FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', '');
...
DROP TRIGGER IF EXISTS sd_fk_live_model_profiles_installed_by_workspace_member_id ON model_profiles;
CREATE TRIGGER sd_fk_live_model_profiles_installed_by_workspace_member_id BEFORE INSERT OR UPDATE OF installed_by_workspace_member_id, deleted_at ON model_profiles FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'installed_by_workspace_member_id', 'id', 'true', '');
...
CREATE TRIGGER sd_fk_live_model_group_grants_granted_by_workspace_member_id BEFORE INSERT OR UPDATE OF granted_by_workspace_member_id, status ON model_group_grants FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'granted_by_workspace_member_id', 'id', 'false', 'active');
...
CREATE TRIGGER sd_fk_live_transport_accounts_inbound_actor_id BEFORE INSERT OR UPDATE OF inbound_actor_id, deleted_at, status ON transport_accounts FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('actors', 'inbound_actor_id', 'id', 'true', 'active,disabled,error');
...
CREATE TRIGGER sd_fk_live_transport_addresses_workspace_member_id BEFORE INSERT OR UPDATE OF workspace_member_id ON transport_addresses FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_automation_event_sources_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at, status ON automation_event_sources FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', 'active,deprecated,disabled');
DROP TRIGGER IF EXISTS sd_fk_live_automation_event_sources_created_by_actor_id ON automation_event_sources;
CREATE TRIGGER sd_fk_live_automation_event_sources_created_by_actor_id BEFORE INSERT OR UPDATE OF created_by_actor_id, deleted_at, status ON automation_event_sources FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('actors', 'created_by_actor_id', 'id', 'true', 'active,deprecated,disabled');
...
CREATE TRIGGER sd_fk_live_automation_webhook_endpoints_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at, status ON automation_webhook_endpoints FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', 'active,disabled');
...
CREATE TRIGGER sd_fk_live_memory_recall_runs_workspace_member_id BEFORE INSERT OR UPDATE OF workspace_member_id ON memory_recall_runs FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'workspace_member_id', 'id', 'false', '');
...
DROP TRIGGER IF EXISTS sd_fk_live_installed_skills_created_by_workspace_member_id ON installed_skills;
CREATE TRIGGER sd_fk_live_installed_skills_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, deleted_at ON installed_skills FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'true', '');
...
CREATE TRIGGER sd_fk_live_skill_versions_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id ON skill_versions FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_plugin_installations_workspace_id BEFORE INSERT OR UPDATE OF workspace_id, deleted_at, status ON plugin_installations FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspaces', 'workspace_id', 'id', 'true', 'active,disabled,error');
DROP TRIGGER IF EXISTS sd_fk_live_plugin_installations_catalog_item_id ON plugin_installations;
CREATE TRIGGER sd_fk_live_plugin_installations_catalog_item_id BEFORE INSERT OR UPDATE OF catalog_item_id, deleted_at, status ON plugin_installations FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('catalog_items', 'catalog_item_id', 'id', 'true', 'active,disabled,error');
DROP TRIGGER IF EXISTS sd_fk_live_plugin_installations_installed_by_workspace_member_id ON plugin_installations;
CREATE TRIGGER sd_fk_live_plugin_installations_installed_by_workspace_member_id BEFORE INSERT OR UPDATE OF installed_by_workspace_member_id, deleted_at, status ON plugin_installations FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'installed_by_workspace_member_id', 'id', 'true', 'active,disabled,error');
...
DROP TRIGGER IF EXISTS sd_fk_live_plugin_connections_owner_workspace_member_id ON plugin_connections;
CREATE TRIGGER sd_fk_live_plugin_connections_owner_workspace_member_id BEFORE INSERT OR UPDATE OF owner_workspace_member_id, deleted_at, status ON plugin_connections FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'owner_workspace_member_id', 'id', 'true', 'active');
...
CREATE TRIGGER sd_fk_live_resource_access_bindings_installed_skill_id BEFORE INSERT OR UPDATE OF installed_skill_id, status ON resource_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('installed_skills', 'installed_skill_id', 'id', 'false', 'active');
DROP TRIGGER IF EXISTS sd_fk_live_resource_access_bindings_plugin_installation_id ON resource_access_bindings;
CREATE TRIGGER sd_fk_live_resource_access_bindings_plugin_installation_id BEFORE INSERT OR UPDATE OF plugin_installation_id, status ON resource_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('plugin_installations', 'plugin_installation_id', 'id', 'false', 'active');
...
CREATE TRIGGER sd_fk_live_resource_access_bindings_actor_id BEFORE INSERT OR UPDATE OF actor_id, status ON resource_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('actors', 'actor_id', 'id', 'false', 'active');
DROP TRIGGER IF EXISTS sd_fk_live_resource_access_bindings_remote_agent_id ON resource_access_bindings;
CREATE TRIGGER sd_fk_live_resource_access_bindings_remote_agent_id BEFORE INSERT OR UPDATE OF remote_agent_id, status ON resource_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('remote_agents', 'remote_agent_id', 'id', 'false', 'active');
DROP TRIGGER IF EXISTS sd_fk_live_resource_access_bindings_created_by_workspace_member_id ON resource_access_bindings;
CREATE TRIGGER sd_fk_live_resource_access_bindings_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, status ON resource_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', 'active');
DROP TRIGGER IF EXISTS sd_fk_live_interaction_response_commands_created_by_workspace_member_id ON interaction_response_commands;
CREATE TRIGGER sd_fk_live_interaction_response_commands_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id ON interaction_response_commands FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_runtime_authorization_grants_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, status ON runtime_authorization_grants FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', 'active');
...
CREATE TRIGGER sd_fk_live_devices_owner_workspace_member_id BEFORE INSERT OR UPDATE OF owner_workspace_member_id, deleted_at ON devices FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'owner_workspace_member_id', 'id', 'true', '');
...
CREATE TRIGGER sd_fk_live_device_capabilities_workspace_id BEFORE INSERT OR UPDATE OF workspace_id, status ON device_capabilities FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspaces', 'workspace_id', 'id', 'false', 'active,deprecated');
DROP TRIGGER IF EXISTS sd_fk_live_device_capabilities_exposure_id ON device_capabilities;
CREATE TRIGGER sd_fk_live_device_capabilities_exposure_id BEFORE INSERT OR UPDATE OF exposure_id, status ON device_capabilities FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('device_exposures', 'exposure_id', 'id', 'false', 'active,deprecated');
...
CREATE TRIGGER sd_fk_live_device_tools_exposure_id BEFORE INSERT OR UPDATE OF exposure_id ON device_tools FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('device_exposures', 'exposure_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_device_operations_initiated_by_workspace_member_id BEFORE INSERT OR UPDATE OF initiated_by_workspace_member_id ON device_operations FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'initiated_by_workspace_member_id', 'id', 'false', '');
...
CREATE TRIGGER sd_fk_live_memory_access_grants_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, status ON memory_access_grants FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', 'active');
...
CREATE TRIGGER sd_fk_live_file_access_grants_created_by_workspace_member_id BEFORE INSERT OR UPDATE OF created_by_workspace_member_id, status ON file_access_grants FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('workspace_members', 'created_by_workspace_member_id', 'id', 'false', 'active');
DROP TRIGGER IF EXISTS sd_fk_live_platform_access_bindings_revoked_by_user_id ON platform_access_bindings;
CREATE TRIGGER sd_fk_live_platform_access_bindings_revoked_by_user_id BEFORE INSERT OR UPDATE OF revoked_by_user_id, status ON platform_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('users', 'revoked_by_user_id', 'id', 'false', 'active');
...
DROP TRIGGER IF EXISTS sd_fk_live_resource_access_bindings_device_capability_id ON resource_access_bindings;
CREATE TRIGGER sd_fk_live_resource_access_bindings_device_capability_id BEFORE INSERT OR UPDATE OF device_capability_id, status ON resource_access_bindings FOR EACH ROW EXECUTE FUNCTION sd_assert_parent_live('device_capabilities', 'device_capability_id', 'id', 'false', 'active');
...
CREATE VIEW actors_live AS SELECT base.* FROM actors base WHERE deleted_at IS NULL AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) WITH CASCADED CHECK OPTION;
...
CREATE VIEW plugin_installations_live AS SELECT base.* FROM plugin_installations base WHERE deleted_at IS NULL AND status IN ('active', 'disabled', 'error') AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) AND (base.catalog_item_id IS NULL OR EXISTS (SELECT 1 FROM catalog_items_live lp1 WHERE lp1.id = base.catalog_item_id)) WITH CASCADED CHECK OPTION;
...
CREATE VIEW device_capabilities_live AS SELECT base.* FROM device_capabilities base WHERE status IN ('active', 'deprecated') AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) AND (base.exposure_id IS NULL OR EXISTS (SELECT 1 FROM device_exposures_live lp1 WHERE lp1.id = base.exposure_id)) WITH CASCADED CHECK OPTION;
CREATE VIEW device_tools_live AS SELECT base.* FROM device_tools base WHERE (base.exposure_id IS NULL OR EXISTS (SELECT 1 FROM device_exposures_live lp0 WHERE lp0.id = base.exposure_id)) WITH CASCADED CHECK OPTION;
...
CREATE VIEW installed_skills_live AS SELECT base.* FROM installed_skills base WHERE deleted_at IS NULL AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) WITH CASCADED CHECK OPTION;
...
CREATE VIEW model_profiles_live AS SELECT base.* FROM model_profiles base WHERE deleted_at IS NULL AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) WITH CASCADED CHECK OPTION;
...
CREATE VIEW remote_agents_live AS SELECT base.* FROM remote_agents base WHERE deleted_at IS NULL AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) WITH CASCADED CHECK OPTION;
CREATE VIEW resource_access_bindings_live AS SELECT base.* FROM resource_access_bindings base WHERE status IN ('active') AND (base.workspace_id IS NULL OR EXISTS (SELECT 1 FROM workspaces_live lp0 WHERE lp0.id = base.workspace_id)) AND (base.installed_skill_id IS NULL OR EXISTS (SELECT 1 FROM installed_skills_live lp1 WHERE lp1.id = base.installed_skill_id)) AND (base.plugin_installation_id IS NULL OR EXISTS (SELECT 1 FROM plugin_installations_live lp2 WHERE lp2.id = base.plugin_installation_id)) AND (base.automation_event_source_id IS NULL OR EXISTS (SELECT 1 FROM automation_event_sources_live lp3 WHERE lp3.id = base.automation_event_source_id)) AND (base.actor_id IS NULL OR EXISTS (SELECT 1 FROM actors_live lp4 WHERE lp4.id = base.actor_id)) AND (base.remote_agent_id IS NULL OR EXISTS (SELECT 1 FROM remote_agents_live lp5 WHERE lp5.id = base.remote_agent_id)) AND (base.device_capability_id IS NULL OR EXISTS (SELECT 1 FROM device_capabilities_live lp6 WHERE lp6.id = base.device_capability_id)) WITH CASCADED CHECK OPTION;
